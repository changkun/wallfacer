...
func TestUpdateExistingKeys(t *testing.T) {
	...
	if err := envconfig.Update(path, ptr("new-token"), nil, ptr("https://new.example.com"), nil, nil, ptr("claude-haiku-4-5"), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil); err != nil {
...
func TestUpdateNilSkips(t *testing.T) {
	...
	if err := envconfig.Update(path, nil, nil, ptr("https://example.com"), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil); err != nil {
		t.Fatalf("Update: %v", err)
	}
...
func TestUpdateClearsField(t *testing.T) {
	...
	if err := envconfig.Update(path, nil, nil, ptr(""), nil, nil, ptr(""), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil); err != nil {
		t.Fatalf("Update: %v", err)
	}
...
func TestUpdateAppendsNewKeys(t *testing.T) {
	...
	if err := envconfig.Update(path, nil, nil, ptr("https://example.com"), nil, nil, ptr("claude-sonnet-4-5"), ptr("claude-haiku-4-5"), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil); err != nil {
		t.Fatalf("Update: %v", err)
	}
...
func TestUpdatePreservesComments(t *testing.T) {
	...
	if err := envconfig.Update(path, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil); err != nil {
		t.Fatalf("Update: %v", err)
	}
...
func TestUpdateMaxTestParallelTasks(t *testing.T) {
	...
	if err := envconfig.Update(path, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, &v, nil, nil, nil, nil, nil, nil, nil, nil, nil); err != nil {
		t.Fatalf("Update: %v", err)
	}
...
func TestUpdateOversightInterval(t *testing.T) {
	...
	v := "15"
	if err := envconfig.Update(path, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, &v, nil, nil, nil, nil, nil, nil, nil, nil); err != nil {
		t.Fatalf("Update: %v", err)
	}
...
func TestUpdateArchivedTasksPerPage(t *testing.T) {
	...
	v := "40"
	if err := envconfig.Update(path, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, &v, nil, nil, nil, nil, nil, nil, nil); err != nil {
		t.Fatalf("Update: %v", err)
	}
...
func TestUpdateAutoPush(t *testing.T) {
	...
	enabled := "true"
	threshold := "5"
	if err := envconfig.Update(path, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, &enabled, &threshold, nil, nil, nil, nil, nil); err != nil {
		t.Fatalf("Update: %v", err)
	}
