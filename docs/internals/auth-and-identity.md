...
| `SANDBOX_PROXY_CLIENT_ID`, `SANDBOX_PROXY_CLIENT_SECRET` | unset | the confidential client wallfacer mints its own service token with, for the installation-token endpoint |
