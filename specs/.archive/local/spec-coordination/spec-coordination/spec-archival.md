...
2. **Auto-archival on long inactivity.** Should the system offer to archive `complete` specs whose `updated` is older than N months? Useful for cleanup, risky for accidental hiding of specs still in use. Tentative: no auto-archival; always manual.
