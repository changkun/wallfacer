...
| ↳ [spec-planning-ux.md](local/spec-coordination/spec-planning-ux.md) | **In progress** (7/8) | Spec explorer, chat-driven iteration, dispatch workflow, progress tracking. Complete: planning sandbox, UI shell, spec explorer, planning chat agent, dispatch workflow, undo & snapshots, planning cost tracking |
