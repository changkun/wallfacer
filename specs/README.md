...
| [rebrand-module-path.md](local/rebrand-module-path.md) | In progress | Migrate module path and image refs from `changkun.de/x/wallfacer` to `latere.ai/x/wallfacer` |
