...
| [archive-active-task-guard.md](local/archive-active-task-guard.md) | Drafted | Spec archive guard blocks only when a dispatched task is still active; terminal (done/failed/cancelled) or stale links no longer 409. Fixes a complete tree refusing to archive. |
