...
```bash
# 1. Download the binary (or: go build -o wallfacer .)
curl -L https://github.com/changkun/wallfacer/releases/latest/download/wallfacer-$(uname -s | tr A-Z a-z)-$(uname -m | sed 's/x86_64/amd64/;s/aarch64/arm64/') -o wallfacer
chmod +x wallfacer
