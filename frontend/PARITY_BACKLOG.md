...
- [x] modal-diff — highlight.js syntax coloring in diffs
...
- [x] modal-ndjson — thinking blocks inline-expandable (>5 lines "+N lines")
...
- [x] spec-explorer — Task Prompts stay fresh (reload on SSE-synced task status/title changes)
