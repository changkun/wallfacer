  ...
  <header class="site-header">
    <nav class="nav-container">
      ...
      <router-link to="/" class="logo-link">
        <svg class="logo-icon" width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" style="image-rendering:pixelated;"><rect x="0" y="0" width="6" height="3" fill="var(--accent-2)"/><rect x="7" y="0" width="9" height="3" fill="var(--accent)"/><rect x="0" y="4" width="4" height="3" fill="var(--accent)"/><rect x="5" y="4" width="6" height="3" fill="var(--accent-2)"/><rect x="12" y="4" width="4" height="3" fill="var(--accent)"/><rect x="0" y="8" width="7" height="3" fill="var(--accent)"/><rect x="8" y="8" width="8" height="3" fill="var(--accent)"/><rect x="0" y="12" width="3" height="4" fill="var(--accent-2)"/><rect x="4" y="12" width="6" height="4" fill="var(--accent)"/><rect x="11" y="12" width="5" height="4" fill="var(--accent-2)"/></svg>
