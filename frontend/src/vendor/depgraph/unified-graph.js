// Vendored verbatim from ui/js/unified-graph.js for the Map view (MapPage.vue).
// Self-contained IIFE that attaches window.* renderers and reads the
// window shims MapPage installs. Kept identical to the legacy source so
// the dependency-graph behavior matches exactly. When ui/ is deleted this
// becomes the sole copy. Do not add imports — it must stay shim-driven.
